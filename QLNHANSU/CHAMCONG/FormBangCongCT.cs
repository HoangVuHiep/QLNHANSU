...
namespace QLNHANSU
{
    public partial class FormBangCongCT : DevExpress.XtraEditors.XtraForm
    {
        public FormBangCongCT()
        {
            InitializeComponent();
        }
		NHANVIEN _nhanvien;
		...
		public int _thang;
		public int _nam;
		private void FormBangCongCT_Load(object sender, EventArgs e)
        {
			_kycong = new KYCONG();
		...
		private void btnPHATSINHKYCONG_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
			...
			foreach(var item in lstNhanVien)
            {
				...
				{
					tb_BANCONG_NV_CT bcct = new tb_BANCONG_NV_CT();
					bcct.MANV = item.MANV;
					bcct.MACT = item.MACT;
					...
					bcct.THU = HFunctions.layThuTrongTuan(int.Parse(cboNAM.Text), int.Parse(cboTHANG.Text),i);
					bcct.NGAYPHEP = 0;
					bcct.CONGNGAYLE = 0;
					bcct.CONGCHUNHAT = 0;
        ...
        private void btnCAPNHATNGAYCONG_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
